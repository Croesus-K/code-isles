...
export const BUNDLED_ANNOUNCEMENTS: readonly Announcement[] = [
  ...
  },
  {
    ...
    date: '2026-09-18',
    tag: 'feature',
    title: '隐藏岛屿「秘境岛」开放：打赏解锁',
    body: '世界地图末端浮现一座金色虚线的秘密岛屿。打赏后向作者索取专属密钥（ISLE-XXXX-XXXX-XXXX），在打赏弹窗输入即可解锁每门课的毕业加试关卡——8 道专挑老坑的硬核题。解锁附赠「金主赞助人」徽章 🗝。',
  },
  {
  ...
  },
  {
    ...
    tag: 'feature',
    title: '综合挑战模式',
    body: '通关任意关卡后，世界地图底部出现「综合挑战」入口。从已通关题库里随机抽 10 题，答对 +2 XP，答错不污染错题本 —— 复盘老题不用再担心错题本膨胀。',
  },
  {
